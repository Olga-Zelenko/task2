...
class LeftMenuForm:
    __Elements_menu = ButtonElement("//*[@class='header-wrapper']//*[contains(text(),'Elements')]", 'Elements menu')
    __Web_tables_menu_item = ButtonElement("//*[@id='item-3']//*[contains(text(),'Web Tables')]", "Menu item - Alerts")
    __Links_menu_item = ButtonElement("//*[@id='item-5']//*[contains(text(),'Links')]", "Menu item - Links")
    __Alerts_menu_item = ButtonElement("//*[@id='item-1']//*[contains(text(),'Alerts')]", "Menu item - Alerts")
    __Nested_frames_item = ButtonElement("//*[@id='item-3']//*[contains(text(),'Nested Frames')]", 'Menu item - '
                                                                                                   'Nested frames')
    __Frames_item = ButtonElement("//*[@id='item-2']//*[contains(text(),'Frames')]", 'Menu item - Frames')
    __Browser_windows_item = ButtonElement("//*[@id='item-0']//*[contains(text(),'Browser Windows')]",
