...
class LeftMenuForm(BasePage):
    ...
    __ELEMENTS_MENU = Button("//*[@class='header-wrapper']//*[contains(text(),'Elements')]", "elements menu")
    __WEB_TABLES_MENU_ITEM = Button("//*[@id='item-3']//*[contains(text(),'Web Tables')]", "Menu item - Alerts")
    __LINKS_MENU_ITEM = Button("//*[@id='item-5']//*[contains(text(),'Links')]", "Menu item - Links")
    __ALERTS_MENU_ITEM = Button("//*[@id='item-1']//*[contains(text(),'Alerts')]", "Menu item - Alerts")
    __NESTED_FRAMES_ITEM = Button("//*[@id='item-3']//*[contains(text(),'Nested Frames')]",
                                  "Menu item - Nested frames")
    __FRAMES_ITEM = Button("//*[@id='item-2']//*[contains(text(),'Frames')]", "Menu item - Frames")
    __BROWSER_WINDOWS_ITEM = Button("//*[@id='item-0']//*[contains(text(),'Browser Windows')]",
                                    "Menu item - Browser Windows")
    __UNIQ_ELEM_LOCATOR = "//*[contains(@class,'left-pannel')]"

    def __init__(self):
        super().__init__(self.__UNIQ_ELEM_LOCATOR, "Left menu form")
